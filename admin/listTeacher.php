    ...
    die("Connection failed: " . $conn->connect_error);
			...
			if($resultat=mysqli_query($conn,"select * from teacher;")){
				...
				while($ligne=mysqli_fetch_row($resultat)){
					...
					$city=$ligne[5];
					$tel=$ligne[6];
					echo "<tr><td>$id</td><td>$nom</td><td>$prenom</td><td>$email</td><td>$password</td><td>$city</td><td>$tel</td><td><a href='deleteteacher.php?id=$id'><i class='fa fa-trash-o' aria-hidden='true'></i> </a></td>	<tr>";
