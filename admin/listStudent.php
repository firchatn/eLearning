...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
			...
			echo "<h3>Students </h3>";
			if($resultat=mysqli_query($conn,"select * from student;")){
				...
				while($ligne=mysqli_fetch_row($resultat)){
					...
					$birthday=$ligne[6];
					$tel=$ligne[7];
					echo "<tr><td>$id</td><td>$nom</td><td>$prenom</td><td>$email</td><td>$password</td><td>$city</td><td>$birthday</td><td>$tel</td><td><a href='msg.php'><i class='fa fa-trash-o' aria-hidden='true'></i> </a></td><tr>";
